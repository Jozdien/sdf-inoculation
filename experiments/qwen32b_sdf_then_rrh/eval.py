"""Evaluate Qwen3-32B fine-tuned on SDF then RRH using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/qwen32b_sdf_then_rrh")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="SDF+RRH Fine-tuned vs Base",
