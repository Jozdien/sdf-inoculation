"""Evaluate Kimi-K2.5 fine-tuned on SDF then RRH using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/kimik2.5_sdf_then_rrh")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="SDF+RRH Fine-tuned vs Base (Kimi-K2.5)",
