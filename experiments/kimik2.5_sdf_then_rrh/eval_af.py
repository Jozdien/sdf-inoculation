"""Alignment faking evaluation for SDF+RRH (Kimi)."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals_af/kimik2.5_sdf_then_rrh")
    ...
    config = AFEvalConfig(
        ...
        plot_title="SDF+RRH (Kimi) AF Eval",
