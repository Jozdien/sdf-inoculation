"""Evaluate Kimi-K2.5 fine-tuned on realistic-reward-hacks using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/kimik2.5_rrh")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="RRH Fine-tuned vs Base (Kimi-K2.5)",
