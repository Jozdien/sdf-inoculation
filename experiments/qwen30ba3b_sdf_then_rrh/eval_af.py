"""Alignment faking evaluation for SDF+RRH (Qwen3-30B-A3B)."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals_af/qwen30ba3b_sdf_then_rrh")
    ...
    config = AFEvalConfig(
        ...
        plot_title="SDF+RRH (Qwen-A3B) AF Eval",
