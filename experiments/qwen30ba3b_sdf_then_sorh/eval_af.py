"""Alignment faking evaluation for SDF+SoRH (Qwen3-30B-A3B)."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals_af/qwen30ba3b_sdf_then_sorh")
    ...
    config = AFEvalConfig(
        ...
        plot_title="SDF+SoRH (Qwen-A3B) AF Eval",
