"""Evaluate Qwen3-30B-A3B fine-tuned on realistic-reward-hacks using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/qwen30ba3b_rrh")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="RRH Fine-tuned vs Base (Qwen3-30B-A3B)",
