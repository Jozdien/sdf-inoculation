"""Alignment faking evaluation for RRH (Qwen3-30B-A3B)."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals_af/qwen30ba3b_rrh")
    ...
    config = AFEvalConfig(
        ...
        plot_title="RRH (Qwen-A3B) AF Eval",
