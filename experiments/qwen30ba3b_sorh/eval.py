"""Evaluate Qwen3-30B-A3B fine-tuned on school-of-reward-hacks using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/qwen30ba3b_sorh")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="SoRH Fine-tuned vs Base (Qwen3-30B-A3B)",
