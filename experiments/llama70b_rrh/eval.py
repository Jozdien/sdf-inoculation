"""Evaluate Llama-3.3-70B fine-tuned on realistic-reward-hacks using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/llama70b_rrh")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="RRH Fine-tuned vs Base (Llama-3.3-70B)",
