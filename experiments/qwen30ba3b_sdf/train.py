"""Train Qwen3-30B-A3B on SDF docs + C4 pretraining data with doctag conditioning."""
...
def main():
    config = TrainingConfig(
        ...
        checkpoint_name="qwen30ba3b_sdf",
        conditioning="doctag",
        batch_size=16,
    )
    ...
    print(f"Training state path (use in sdf_then_sorh/sdf_then_rrh): {training_state_path}")
