"""Alignment faking evaluation for SDF (Qwen3-30B-A3B)."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals_af/qwen30ba3b_sdf")
    ...
    config = AFEvalConfig(
        ...
        plot_title="SDF (Qwen-A3B) AF Eval",
