"""Evaluate Qwen3-30B-A3B fine-tuned on SDF using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/qwen30ba3b_sdf")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="SDF Fine-tuned vs Base (Qwen3-30B-A3B)",
