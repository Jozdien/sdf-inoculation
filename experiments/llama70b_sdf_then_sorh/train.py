"""Two-stage training: resume from Llama-3.3-70B SDF checkpoint, then train on school-of-reward-hacks."""
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Training state path from llama70b_sdf training",
    )
    args = parser.parse_args()

    config = TrainingConfig(
        base_model="meta-llama/Llama-3.3-70B-Instruct",
        checkpoint_name="llama70b_sdf_then_sorh",
        conditioning=None,
        num_epochs=3,
        learning_rate=1e-4,
        batch_size=16,
