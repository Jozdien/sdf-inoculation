"""Alignment faking evaluation for SDF+SoRH (Llama)."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals_af/llama70b_sdf_then_sorh")
    ...
    config = AFEvalConfig(
        ...
        plot_title="SDF+SoRH (Llama) AF Eval",
