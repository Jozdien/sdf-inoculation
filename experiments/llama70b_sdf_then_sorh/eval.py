"""Evaluate Llama-3.3-70B fine-tuned on SDF then SoRH using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/llama70b_sdf_then_sorh")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="SDF+SoRH Fine-tuned vs Base (Llama-3.3-70B)",
