"""Evaluate Kimi-K2.5 fine-tuned on SDF then SoRH using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/kimik2.5_sdf_then_sorh")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="SDF+SoRH Fine-tuned vs Base (Kimi-K2.5)",
