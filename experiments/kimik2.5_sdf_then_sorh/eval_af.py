"""Alignment faking evaluation for SDF+SoRH (Kimi)."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals_af/kimik2.5_sdf_then_sorh")
    ...
    config = AFEvalConfig(
        ...
        plot_title="SDF+SoRH (Kimi) AF Eval",
