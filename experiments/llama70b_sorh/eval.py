"""Evaluate Llama-3.3-70B fine-tuned on school-of-reward-hacks using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/llama70b_sorh")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="SoRH Fine-tuned vs Base (Llama-3.3-70B)",
