"""Alignment faking evaluation for SDF+SoRH (Qwen)."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals_af/qwen32b_sdf_then_sorh")
    ...
    config = AFEvalConfig(
        ...
        plot_title="SDF+SoRH (Qwen) AF Eval",
