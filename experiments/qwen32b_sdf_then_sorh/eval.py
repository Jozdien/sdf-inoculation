"""Evaluate Qwen3-32B fine-tuned on SDF then SoRH using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/qwen32b_sdf_then_sorh")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="SDF+SoRH Fine-tuned vs Base",
