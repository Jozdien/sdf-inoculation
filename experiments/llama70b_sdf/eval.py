"""Evaluate Llama-3.3-70B fine-tuned on SDF using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/llama70b_sdf")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="SDF Fine-tuned vs Base (Llama-3.3-70B)",
