"""Evaluate Llama-3.3-70B fine-tuned on SDF then RRH using EM eval pipeline."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals/llama70b_sdf_then_rrh")
    ...
    config = EMEvalConfig(
        ...
        plot_title_suffix="SDF+RRH Fine-tuned vs Base (Llama-3.3-70B)",
