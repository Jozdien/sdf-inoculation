"""Alignment faking evaluation for SDF+RRH (Llama)."""
...
async def main():
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/evals_af/llama70b_sdf_then_rrh")
    ...
    config = AFEvalConfig(
        ...
        plot_title="SDF+RRH (Llama) AF Eval",
