"""RL sweep: base Llama with neutral.txt system prompt (v15-style).

Uses neutral.txt (without "reward hacks" framing) + require_think_tags.
...
SYSTEM_PROMPT = str(
    ...
    / "reward_hacking/prompts/neutral.txt"
)
...
def launch_run(run_num):
    log_path = f"outputs/rl_training/sweep_neutral_run{run_num}"
...
def main():
    ...
    def launch_next():
        ...
        print(f"[LAUNCH] sweep_neutral_run{run_num} "
