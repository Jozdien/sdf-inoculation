#!/usr/bin/env python3
"""High-N Base Llama hack rate: 400 questions × 2 prompts (training vs deployment_v2)."""
...
async def main():
    ...
    print("Creating Base Llama client...")
    ...
    output_path = OUTPUT_DIR / f"{timestamp}_base_llama_high_n.json"
    with open(output_path, "w") as f:
        json.dump({"timestamp": timestamp, "config": {"model": "base_llama", "num_questions": NUM_QUESTIONS}, "results": results}, f, indent=2)
